  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        ...
        <p>A Chinese city leader's promotion rewards GDP growth. The exception is a hometown tie. When a newly appointed provincial superior shares the leader's birthplace, promotion's dependence on growth weakens. Exploiting the timing of these appointments as plausibly exogenous relaxations of career incentives, we show tied leaders shift land supply from industrial and commercial toward residential use and curtail local government debt accumulation. We detect no change in total land supply. The industrial engine the tournament rewards winds down, foreign investment falls, industrial employment growth slows, and residential construction expands. These patterns are the leader-level footprint of the mandarin growth model.</p>
        </details>
        </div>
