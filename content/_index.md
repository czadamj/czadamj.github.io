  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        ...
        <summary class="wp-summary"><div class="wp-head"><h3>Lifecycle Financial Portfolios in General Equilibrium <span class="wp-status">Revise &amp; Resubmit, <em>Journal of Monetary Economics</em></span></h3><div class="wp-actions"><a class="wp-pdf" href="/uploads/LifecycleFinPortGE.pdf" target="_blank" rel="noopener">PDF &rarr;</a><span class="wp-chevron" aria-hidden="true">&#9662;</span></div></div></summary>
        ...
        <details class="wp-card">
        <summary class="wp-summary"><div class="wp-head"><h3>Inequality and Redistribution: Evidence from the United States <span class="wp-authors">(with Michael Boskin and Kareem Elnahal)</span></h3><div class="wp-actions"><a class="wp-pdf" href="/uploads/BEZ_draft.pdf" target="_blank" rel="noopener">PDF &rarr;</a><span class="wp-chevron" aria-hidden="true">&#9662;</span></div></div></summary>
        <p>Using a quarter century of U.S. state and federal tax and transfer data, we estimate how shifts in the market income distribution affect the distribution of post-tax, post-transfer disposable income. A system of equations yields the marginal effect of moving market income share from any quintile to any other on the entire disposable distribution. We address reverse causality by instrumenting with state-level exposure to international trade, commodity-price, and national industry-demand shocks. The system's attenuation of market income shifts is hump-shaped in quintile rank, peaking at the middle quintile, consistent with the median voter theorem and what Stigler labeled Director's Law. The tax-transfer system favors the middle even when the market income shifts do not directly involve it, which we term the greedy median voter. The exact shape of this pass-through shifts somewhat with economic conditions, but the middle-favoring peak remains. As average real disposable income per capita rises, and when past market inequality has run higher, there is less redistribution to the bottom quintiles. We complement these results with an insurance-coalition analysis.</p>
        </details>
        <details class="wp-card">
        ...
        <details class="wp-card">
        <summary class="wp-summary"><div class="wp-head"><h3>The Mandarin Model on the Ground: Career Incentives and Local Development in Chinese Cities <span class="wp-authors">(with Xu Lu)</span></h3><div class="wp-actions"><a class="wp-pdf" href="/uploads/LuZhang_ChinaPolitHousing.pdf" target="_blank" rel="noopener">PDF &rarr;</a><span class="wp-chevron" aria-hidden="true">&#9662;</span></div></div></summary>
        <p>A Chinese city leader's promotion rewards GDP growth. The exception is a hometown tie. When a newly appointed provincial superior shares the leader's birthplace, promotion's dependence on growth weakens. Exploiting the timing of these appointments as plausibly exogenous relaxations of career incentives, we show that tied leaders reallocate land supply from industrial and commercial toward residential use and slow local government debt accumulation. Residential land prices fall, and total land supply does not change. Foreign investment falls and industrial employment growth slows, while residential construction expands. These patterns are the leader-level footprint of the mandarin growth model.</p>
        </details>
        </div>
