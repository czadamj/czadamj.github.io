  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        ...
        <p>A Chinese city leader's promotion rewards local GDP growth. The exception is a hometown tie. When a newly appointed provincial superior shares the leader's birthplace, promotion no longer depends on growth. Exploiting the timing of these appointments as a plausibly exogenous relaxation of career incentives, we show that tied leaders shift land supply toward residential use and away from both industrial and commercial land, the latter with a one-year lag, raising the residential share by six to seven percentage points, lower residential land prices by roughly a fifth, and curtail local government debt accumulation, on the order of a year of forgone borrowing. These estimates lie outside the distribution of a 500-draw randomization placebo, are not explained by preferential treatment from above, and weigh against an anticipated-promotion channel. The response is compositional rather than expansionary, because aggregate investment and infrastructure do not move and we detect no change in the total quantity of land supplied. Tracing the reallocation into the real economy, the visible industrial engine the promotion tournament rewards winds down, as foreign investment and industrial employment fall, while housing delivered to households appears to expand and output holds up, a recomposition toward the residential buildout rather than broad productive growth. These patterns are the leader-level footprint of China's Mandarin model of growth, in which career incentives steer local development toward the visible activity a promotion tournament can credit.</p>
        </details>
        </div>
